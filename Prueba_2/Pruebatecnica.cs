...
class Program
{
    ...
    static void ListarTop10Usuarios(string connectionString)
    {
    ...
    static void GenerarArchivoCSV(string connectionString)
    {
    ...
    static void ActualizarSalario(int userId, double nuevoSalario, string connectionString)
    {
    ...
    static void AgregarUsuario(string login, string nombre, string paterno, string materno, double salarioPredeterminado, string connectionString)
    {
